	...
	<div class="contain h-100">
		...
		<div>
			...
			<table class="table table-striped table-bordered" id="product_table" style="margin-top: -22px;">
				<thead>
					<tr>
						<th scope="col" class="column-text">Id.Produkt</th>
						<th scope="col" class="column-text">Emer Produkti</th>
						<th scope="col" class="column-text">Cmimi</th>
						<th scope="col" class="column-text">Gjendja</th>
						<th scope="col" class="column-text">Njeasia</th>
						<th scope="col" class="column-text">Gjendja Minimale</th>

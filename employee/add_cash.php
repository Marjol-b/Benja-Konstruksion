...
<body>
	<div class="contain h-100">
		...
		<div class="main">
			<div class="side">
				<h1 class="ml-4"><i class="fas fa-money-bill-alt"></i>Menaxhimi i gjendjes ditore</h1>
				<hr>
			</div>
			...
			<dir class="second_side">
					...
					<div class="text-left mt-5" style="margin-top: 50px;">
						...
						<button type="submit" name="add_customer" class="btn btn-secondary"><i class="fas fa-check-circle"></i> Konfirmo</button>
						<button class="btn btn-danger ml-2" onclick="window.location.href='../cashflow/cashflow.php" ><i class="fas fa-ban"></i>Anullo</button>
					</div>
				</form>
			</dir>
		</div>

...
<div class="sidebar">
	...
	<button id="sidebar_button" onclick="window.location.href='../employee/profile.php'"><i class="fas fa-user-circle"></i>Profili</button>
	<button id="sidebar_button" type="button" data-toggle="popover" title="User Management" data-content="Here you will update, delete your profile." data-placement="bottom"><i class="fas fa-question"></i> Ndihme</button>
	<div class="fixed-bottom">
		<button class="btn m-2 p-2" id="sidebar_button" onclick="window.location.href='../employee_page.php'"><i class="fas fa-arrow-alt-circle-left"></i> Kthehu Pas</button>
	</div>
</div>
		<div class="main">
			<div class="side">
				<h1 class="ml-4"><i class="fas fa-users"></i>Menaxhimi i Perdoruesve</h1>
				<hr>
			</div>

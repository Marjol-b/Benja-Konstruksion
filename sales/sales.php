...
<body>
	<div class="contain h-100">
		...
		<div class="pr-1">
			<div>
				<h1 class="ml-4 pt-2" align="left"><i class="fas fa-shopping-cart"></i>Informacione rreth shitjeve</h1>
			</div>
			...
			<table class="table table-bordered table-striped" id="sales_table" style="margin-top: -22px;">
				<thead>
					<tr>
						<th scope="col" class="column-text">Nr.Fature</th>
						<th scope="col" class="column-text">Arketari</th>
						<th scope="col" class="column-text">Emer Klienti</th>
						<th scope="col" class="column-text">Ulje(%)</th>
						<th scope="col" class="column-text">Vlera(Lek)</th>

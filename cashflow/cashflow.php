...
<body>
	<div class="contain h-100">
		...
		?>
		<div>
			<h1 class="ml-4 pt-2"><i class="fas fa-money-bill-alt"></i>Menaxhimi i  gjendjes ditore</h1>
			<hr>
			<div class="table-responsive mt-4 pl-5 pr-5">
			<table class="table table-striped" id="cashflow_table" style="margin-top: -22px;">
				<thead>
					<tr>
						<th scope="col" class="column-text">Emri Perdoruesit</th>
						<th scope="col" class="column-text">Arsye</th>
						<th scope="col" class="column-text">Shuma</th>
						<th scope="col" class="column-text">Data</th>
						<th scope="col" class="column-text">Veprimi</th>
					</tr>
				</thead>
					<?php 

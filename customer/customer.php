...
<body>
	<div class="contain h-100">
		...
		?>
		<div>
			<h1 class="ml-4 pt-2"><i class="fas fa-user-friends"></i>Menaxhimi i Klienteve</h1>
			<hr>
			...
			<table class="table table-striped table-bordered" id="customer_table" style="margin-top: -22px;">
				<thead> 
					<tr>
						<th scope="col" class="column-text">ID.Klienti</th>
						<th scope="col" class="column-text">Emer Klienti</th>
						<th scope="col" class="column-text">Adresa</th>
						<th scope="col" class="column-text">Numer Kontakti</th>

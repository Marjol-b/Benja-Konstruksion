...
<body>
	<div class="contain h-100">
		...
		?>
		<div>
			<h1 class="ml-4 pt-2"><i class="fas fa-user-friends"></i>Menaxhim i Klienteve</h1>
			<hr>
			...
			<table class="table table-striped table-bordered table-sm" id="customer_table" style="margin-top: -22px;">
				<?php $row1 = mysqli_fetch_assoc($result1);
					echo "<h3>Emer Klienti:<span style='color:blue;'>".$row1['firstname'].'&nbsp'.$row1['lastname']."</span></h3>";
				?>
				<thead> 
					<tr>
						<th scope="col" class="column-text">Nr.Fature</th>
						<th scope="col" class="column-text">Vlera Totale</th>
						<th scope="col" class="column-text">Sasia Totale</th>

...
<body>
	...
	<img class="img-fluid w-100 mt-2 ml-1" src="../images/logo_reale.png" >
</div>
<div class="sidebar">
	<button><h3><i class="fas fa-tachometer-alt"></i> Faqe Kryesore</h3></button>
	<button id="sidebar_button" onclick="window.location.href='../customer/customer.php'"><i class="fas fa-list-ul"></i>Lista e Klienteve</button>
	<button id="sidebar_button" onclick="window.location.href='../customer/add_customer.php'"><i class="fas fa-user-plus"></i>Shto Klient</button>
	<button id="sidebar_button" type="button" data-toggle="popover" title="Customer Management" data-content="Here you will create, update, delete and customer profiles." data-placement="bottom"><i class="fas fa-question"></i> Ndihme</button>
	<div class="fixed-bottom">
		<button class="btn m-2 p-2" id="sidebar_button" onclick="window.location.href='../main.php'"><i class="fas fa-arrow-alt-circle-left"></i>Kthehu Pas</button>
	</div>
</div>
		<div class="main">
			<div class="side">
			...
			<div class="second_side">
					...
					<table class="mt-5">
						<tbody>
							...
							<tr>
								...
								<td class="pl-5 pb-1"><div class="input-group"><div class="input-group-prepend"><span class="input-group-text" id="basic-addon1"><i class="fas fa-phone"></i></span></div><input type="text" name="number"  title='Phone Number (Format: +99(99)9999-9999)' class="form-control-sm form-control" value="<?php echo $row['contact_number'];?>" required></div></td>
							</tr>
							<tr>
								<td>Change Photo:</td>
					...
					<div class="text-left mt-2">
						...
						<button type="submit" name="update_customer" class="btn btn-secondary"><i class="fas fa-thumbs-up"></i>Ndrysho</button>
						<button type="button" class="btn btn-danger" onclick="window.location.href='../customer/customer.php'" ><i class="fas fa-ban"></i>Anullo</button>
					<?php } ?>
					</div>
				</form>
			</dir>

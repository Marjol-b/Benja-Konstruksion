					...
					<table class="table-responsive mt-5">
						<tbody>
							...
							<tr>
								...
								<td class="pl-5 pb-2"><div class="input-group"><div class="input-group-prepend"><span class="input-group-text" id="basic-addon1"><i class="fas fa-phone"></i></span></div><input type="text" name="number" class="form-control-sm form-control" title='Phone Number (Format: +99(99)9999-9999)' placeholder="Enter Contact number" required></div></td>
							</tr>
						</tbody>
					</table>
					<div class="text-left mt-4">
						<button type="submit" name="add_customer" class="btn btn-secondary"><i class="fas fa-thumbs-up"></i> Konfirmo</button>
						<button class="btn btn-danger" onclick="window.location.href='../customer/customer.php'" ><i class="fas fa-ban"></i>Anullo</button>
					</div>
				</form>
			</div>
		</div>

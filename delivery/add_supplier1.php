		...
		<div class="modal-content" style="width:70%; margin-left: 20%;">
	  	...
	  	<div class="modal-body">
			<div class="container-fluid">
				<form method="post" id="modal-form" action="../delivery/supplier_add1.php" enctype="multipart/form-data" class="needs-validation">
		  			<div>
		  			<div align="center">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-outline-danger" data-dismiss="modal"><i class="fas fa-ban"></i>Anullo</button>
				<button  type="submit" name="submit" class="btn btn-secondary" form="modal-form">Konfirmo</button>
			</div>
		</div>
	</div>
</div>

...
<body>
	<div class="contain h-100">
		...
		<div class="">
			<div>
				<h1 class="ml-4 pt-2 pb-4" align="left"><i class="fas fa-truck"></i> Dergesat</h1>
			</div>
			...
			<table class="table table-sm table-striped table-bordered" id="sales_table" style="margin-top: -22px;">
				<thead>
					...
					<tr>
						...
						<th scope="col" class="column-text">Taksa</th>
						<th scope="col" class="column-text">Cmimi i Shitjes</th>
					</tr>
				</thead>

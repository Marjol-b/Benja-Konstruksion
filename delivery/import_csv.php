			...
			<div class="second_side">
					<table class="table-responsive mt-4">
						...
						<tbody>
							...
							<tr>
								<td valign="baseline"><small>Emri i Furnizuesit:</small></td>
								<td class="pl-5 pb-1">
							...
							<tr>
								<td valign="baseline"><small>Id.Produkt:</small></td>

		...
		<div class="modal-content text-center">
			...
			<div class="modal-body">
				<div>
					...
					<input class="form-control-sm form-control" type="text" name="username" placeholder="Emer Perodruesi" required/></div>
					...
					<input class="form-control-sm form-control" type="password" name="password" placeholder="Fjalkalimi" required/>
					<input type="hidden" name="position" value="I Punesuar"/></div>
				</div>
				<div class="modal-footer">

					<button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fas fa-ban"></i>  Mbyll</button>
					<button type="submit" name='login' class="btn btn-success"><i class="fas fa-sign-in-alt"></i>Hyr</button>					
				</div>
			</form>
			</div>
		</div>

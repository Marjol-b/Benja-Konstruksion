...
<body class="bg-dark">
	<div class="text-center border border-dark">
		<div class="main">
			<img class="img-fluid" src="images/logo_reale.png"/>
		...
		<div class="fixed-bottom mb-2">
			...
			<div class="d-inline">
				<button type="button" id="user" class="btn-lg btn-secondary" data-toggle="modal" data-target="#modal-user"><i class="fas fa-user"></i> I Punesuar</button>
			</div>
		</div>
	</div>

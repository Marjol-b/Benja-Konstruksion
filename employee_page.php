...
<body>
	<div class="h-100 bg-dark" id="container">
		<div id="header">
			...
			<div>
				<img class="img-fluid m-2 w-100" src="BenjaKonstruksion/benjalogo.jpg"/>
			...
			<div class="text-white mt-0 ml-5">
				<table class="table-responsive-sm">
					<tbody>
						...
						<tr>
							<td valign="baseline"><input type="hidden" id="uname" value="<?php echo $user; ?>" /><small>Emer Klienti:<small></td>
							<td valign="baseline"><small><div class="content p-0 ml-5"><input type="text" class="form-control form-control-sm customer_search" autocomplete="off" data-provide="typeahead" id="customer_search" placeholder="Kerko emrin e klientit" name="customer"/></div>
			...
			<div class="header_price border p-0">
				<h5>Total</h5>
				<p class="pb-0 mr-2 mb-2" style="float: right; font-size: 40px;" id="totalValue">Lek 0.00</p>
			</div>
		</div>
			...
			<div id="table_buttons">
				...
				<div class="">
					...
					<ul class="text-white justify-content-center">
						<li class="mb-0">Ulje (%): <input style="width: 100px" type="number" name="discount" value="" min="1" placeholder="Enter Discount" id="discount"></li>
						...
						<li class="d-flex">Total:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<p id="totalValue1">Lek 0.00</p></li>
					</ul>
				</small>
				</div>
			</div>
		...
		<div id="footer" class="w-100" align="center" style="">
			<button id="buttons" onclick="window.location.href='employee/profile.php'" class="btn btn-secondary border mr-2 ml-2"><i class="fas fa-user-circle"></i>Profili</button>
			<button id="buttons" onclick="window.location.href='employee/inventory.php'" class="btn btn-secondary border mr-2"><i class="fas fa-box-open"></i>Inventari</button>
			<button id="buttons" onclick="window.location.href='employee/cashflow.php'" class="btn btn-secondary border mr-2"><i class="fas fa-money-bill-wave"></i>Raportimet</button>
			<button id="buttons" name="logout" type="button" onclick="out();" class="logout btn btn-danger border mr-2"/> <i class="fas fa-sign-out-alt"></i>Dil</div>
		</div>
	</div>
	<?php include('add.php');?>

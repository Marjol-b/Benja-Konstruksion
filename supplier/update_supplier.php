...
<div class="sidebar">
	...
	<button id="sidebar_button" type="button" data-toggle="popover" title="Supplier Management" data-content="Here you will create, update, delete and view supplier profiles." data-placement="bottom"><i class="fas fa-question"></i>  Ndihme</button>
	<div class="fixed-bottom">
		...
		<div class="main">
			<div class="side">
				<h1 class="ml-4">Menaxhimi i Furnitoreve</h1>
				<hr>
			</div>
			...
			<div class="second_side table-responsive">
					...
					<table class="mt-5">
						<tbody>
							...
							<tr>
								<td  valign="baseline">Numri Tel:</td>
					...
					<div class="text-left mt-3">
						...
						<button type="button" class="btn btn-danger" onclick="window.location.href='../supplier/supplier.php'" ><i class="fas fa-ban"></i>Anullo</button>
					<?php } ?>
					</div>
				</form>
			</dir>

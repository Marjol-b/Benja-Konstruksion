...
<body>
	<div class="contain h-100">
		...
		<div>
			<h1 class="ml-4 pt-2"><i class="fas fa-user-tie"></i>Menaxhimi i Furnitoreve</h1>
			...
			<table class="table table-striped table-bordered" id="supplier_table">
				<thead>
					<tr>
						<th scope="col" class="column-text">Nr.Furnitori</th>
						<th scope="col" class="column-text">Emri i Kompanise</th>
						<th scope="col" class="column-text">Emer Punetori</th>
						<th scope="col" class="column-text">Adresa</th>
						<th scope="col" class="column-text">Numri i Tel</th>

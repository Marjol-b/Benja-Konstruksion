...
<body>
	<div class="contain h-100">
		...
		<div>
			<h1 class="ml-4 pt-2"><i class="fas fa-box-open"></i>Menaxhimi i Produktit</h1>
			<hr>
			...
			<table class="table table-striped table-bordered" id="product_table" style="margin-top: -22px;">
				<thead>
					<tr>
						<th scope="col" class="column-text"><Id class="Produkt"></Id></th>
						<th scope="col" class="column-text">Emer Produkti</th>
						<th scope="col" class="column-text">Cmimi</th>
						<th scope="col" class="column-text">Gjendje</th>
						<th scope="col" class="column-text">Njesia</th>
						<th scope="col" class="column-text">Gjendje Minimale</th>
						<th scope="col" class="column-text">Pershkrimi</th>
						<th scope="col" class="column-text">Vendndodhja</th>
						<th scope="col" class="column-text">Veprimet</th>
					</tr>
				</thead>

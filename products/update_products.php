...
<body>
	...
	<button id="sidebar_button" onclick="window.location.href='../products/products.php'"><i class="fas fa-list-ul"></i> Lista e Produkteve</button>
	<button id="sidebar_button" onclick="window.location.href='../delivery/add_delivery.php'"><i class="fas fa-truck"></i> Dergesat</button>
	<button id="sidebar_button" type="button" data-toggle="popover" title="Product Management" data-content="Here you will create, update, delete and view products." data-placement="bottom"><i class="fas fa-question"></i> Ndihme</button>
	<div class="fixed-bottom">
		...
		<div class="main">
			<div class="side">
				<h1 class="ml-4">Menaxhim i Produkteve</h1>
				<hr>
			</div>
			...
			<div class="second_side table-responsive">
					...
					<div class="text-left mt-3">
						<button type="submit" name="update" class="btn btn-secondary"><i class="fas fa-thumbs-up"></i> Ndrysho</button>
